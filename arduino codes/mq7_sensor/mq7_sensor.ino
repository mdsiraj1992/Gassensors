...
void setup() {
  ...
  Ro = MQCalibration(MQ7PIN);                       //Calibrating the sensor. Please make sure the sensor is in clean air 
...
void loop() {
   ...
   Serial.print(MQGetGasPercentage(MQRead(MQ7PIN)/Ro,GAS_HYDROGEN) );
   Serial.print( "ppm" );
   Serial.print("    ");   
   Serial.print("LPG:"); 
   Serial.print(MQGetGasPercentage(MQRead(MQ7PIN)/Ro,GAS_LPG) );
   Serial.print( "ppm" );
   Serial.print("    ");   
   Serial.print("METHANE:"); 
   Serial.print(MQGetGasPercentage(MQRead(MQ7PIN)/Ro,GAS_METHANE) );
   Serial.print( "ppm" );
   Serial.print("    ");   
   Serial.print("ALCOHOL:"); 
   Serial.print(MQGetGasPercentage(MQRead(MQ7PIN)/Ro,GAS_ALCOHOL) );
   Serial.print( "ppm" );
   Serial.print("\n");
   delay(200);
}
